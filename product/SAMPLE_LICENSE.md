...
The Sample includes material governed by the MIT License and Apache License
2.0. Those licenses and their preserved notices govern the corresponding files
and take precedence over these terms where applicable. The purchase does not
...
private toolchain images. It is not a turnkey hidden-reward runtime, a production
benchmark, or a guarantee of model performance.

## No warranty

Except where required by law, the Sample is provided as-is, without warranties
of merchantability, fitness for a particular purpose, non-infringement, or
guaranteed compatibility with any particular model or toolchain.

Questions can be sent to `root@puul.ai`.
